...
public class Formula1 {
    ...
    private static void crearEscuderies(List<Cotxe> cotxes, List<Box> pitLane) {
        ...
        Pilot Alonso = new Pilot("F. Alonso", AstonMartin, 3, 0, 1000000.0);
        Pilot Stroll = new Pilot("L.Stroll", AstonMartin, 4, 0, 100000.0);
        Pilot Hamilton = new Pilot("L. Hamilton", Mercedes, 5, 0, 10000000.0);
        Pilot Leclerc = new Pilot("C. Leclerc", Ferrari, 7, 0, 1000000.0);
        Pilot Pérez = new Pilot("S. Pérez", RedBull, 9, 0, 1000000.0);
        Pilot Russell = new Pilot("G.Russell", Mercedes, 6, 0, 1000000.0);
        Pilot Sainz = new Pilot("C. Sainz", Ferrari, 8, 0, 1000000.0);
        Pilot Verstappen = new Pilot("M. Verstappen", RedBull, 10, 0, 100000000.0);
